...
class ChuanglanSmsApi
{
     ...
     */
    public function sendSMS($mobile, $msg, $needstatus = 'true', $extno = '07333')
    {
        //↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
        ...
        //创蓝账号 替换成你自己的账号
        $chuanglan_config['api_account'] = 'BJ1zhidian';

        //创蓝密码 替换成你自己的密码
        $chuanglan_config['api_password'] = 'Zhidian1688';

        $chuanglan_config['extno'] = '07333';
        $chuanglan_config['product'] = '201356329';
...
//↑↑↑↑↑↑↑↑↑↑请在这里配置您的基本信息↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
        ...
        $postArr = array(
            ...
            'product' => $chuanglan_config['product'],
            'extno' => $chuanglan_config['extno'],
        );
